...
"""autogenerated by genpy from time_sync_pkg/SyncData.msg. Do not edit."""
import codecs
import sys
...
class SyncData(genpy.Message):
  _md5sum = "149818d6ea321fa3e69c3870cecbc7b3"
  _type = "time_sync_pkg/SyncData"
...
float32[] intensities    # intensity data [device-specific units].  If your
                         ...
                         # the array empty.
"""
  __slots__ = ['image','scan']
  _slot_types = ['sensor_msgs/Image','sensor_msgs/LaserScan']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SyncData, self).__init__(*args, **kwds)
